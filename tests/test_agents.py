...
class TestTriageHelpers:
    ...
    def test_wants_to_end_sair(self):
        from src.agents.triage import TriageAgent
        assert TriageAgent._wants_to_end("quero sair") is True

    def test_wants_to_end_tchau(self):
        from src.agents.triage import TriageAgent
        assert TriageAgent._wants_to_end("tchau, obrigado") is True

    def test_wants_to_end_normal_message(self):
        from src.agents.triage import TriageAgent
        assert TriageAgent._wants_to_end("quero ver meu limite") is False
